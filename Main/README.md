...
| **DC (A0)** | **GPIO 5** | DATA/CMD| Data/Command Toggle |
| **CS** | **GPIO 15** | CHIP_SEL| Chip Select |
| **VCC** | 3.3V | POWER | Integrated Power |
| **GND** | GND | GROUND | Common Ground |

### 🛠️ ESP32 Expansion Board GVS Wiring
When using the expansion board, use the **GVS (Ground-Voltage-Signal)** headers for easier wiring. Ensure the yellow jumper is set to **3.3V**.

| Component Pin | Expansion Board Pin | Row Type | ESP32 GPIO |
| :--- | :--- | :--- | :--- |
| **OLED GND** | Any **G** Pin | Ground | GND |
| **OLED VCC** | Any **V** Pin | Voltage | 3.3V |
| **D0 (CLK)** | **D18** | **S** (Signal) | GPIO 18 |
| **D1 (MOSI)**| **D23** | **S** (Signal) | GPIO 23 |
| **RES** | **D4** | **S** (Signal) | GPIO 4 |
| **DC** | **D5** | **S** (Signal) | GPIO 5 |
| **CS** | **D15** | **S** (Signal) | GPIO 15 |
...
| :--- | :--- | :--- | :--- |
| **Front Ultrasonic Trig** | TRIG | **GPIO 22** | Distance Pulse (Front) |
| **Front Ultrasonic Echo** | ECHO | **GPIO 21** | Return Timing (Front) |
| **Back Ultrasonic Trig** | TRIG | **GPIO 12** | Distance Pulse (Back) |
| **Back Ultrasonic Echo** | ECHO | **GPIO 2** | Return Timing (Back) |
| **Front IR Sensor** | OUT | **GPIO 34** | Proximity Detection |
| **Back IR Sensor** | OUT | **GPIO 35** | Proximity Detection |
| **I2S Mic SCK** | SCK | **GPIO 16** | Digital Audio Clock |
| **I2S Mic WS** | WS | **GPIO 19** | Word Select |
| **I2S Mic SD** | SD | **GPIO 17** | Serial Data Out |
